...
void VarManager::SetDefaultVarNames()
{
  ...
  fgVariableNames[kDeltaPx] = "px Reco - px MC ";
  fgVariableUnits[kDeltaPx] = "GeV/c";
  fgVariableNames[kPxResolution] = "Resolution (px Reco - px MC) / px MC";
  fgVariableUnits[kPxResolution] = "";
  fgVariableNames[kDeltaPy] = "py Reco - py MC ";
  fgVariableUnits[kDeltaPy] = "GeV/c";
  fgVariableNames[kPyResolution] = "Resolution (py Reco - py MC) / py MC";
  fgVariableUnits[kPyResolution] = "";
  fgVariableNames[kDeltaPz] = "pz Reco - pz MC ";
  fgVariableUnits[kDeltaPz] = "GeV/c";
  fgVariableNames[kPzResolution] = "Resolution (pz Reco - pz MC) / pz MC";
  fgVariableUnits[kPzResolution] = "";
  fgVariableNames[kEtaResolution] = "Resolution (eta Reco - eta MC) / eta MC";
  ...
  fgVarNamesMap["kMCPt"] = kPtResolution;
